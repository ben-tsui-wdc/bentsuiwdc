...
class GodzillaIntegrationTest(IntegrationExtensions, GodzillaTestCase):
    ...
    class Environment(IntegrationExtensions.Environment, GodzillaTestCase.Environment):

        def init_integration_components(self, of_inst):
            """ Initiate components """
            super(GodzillaIntegrationTest.Environment, self).init_integration_components(of_inst)
            target_inst = of_inst

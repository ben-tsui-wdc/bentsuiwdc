# -*- coding: utf-8 -*-
""" Test case to install and uninstall different app at the same time for admin user
    https://jira.wdmv.wdc.com/browse/KAM-32614
"""
...
class ConcurrentInstallUninstallDifferentAppAdminUser(TestCase):

    TEST_SUITE = 'APP_Manager_Test'
    TEST_NAME = 'KAM-32614 - Install and uninstall different app at the same time for admin user'
    # Popcorn
    TEST_TYPE = 'Functional'
    TEST_JIRA_ID = 'KAM-32614'
    PRIORITY = 'Major'
    COMPONENT = 'PLATFORM'
    ISSUE_JIRA_ID = None
    ...
    def before_test(self):
        ...
        # For admin user import and new different object for different app install/uninstall
    ...
    def test(self):
        ...
        time.sleep(10)
        self.log.info('Start to uninstall app({0}) and install app({1}) by admin user at the same time'
            .format(self.app_id_1, self.app_id_2))
        self.concurrent_install_uninstall()
        self.log.info("*** Install and uninstall different app at the same time for admin user, Test PASSED !!!")
...
if __name__ == '__main__':
    parser = InputArgumentParser("""\
        *** Install and uninstall different app at the same time for admin user test ***
        Examples: ./start.sh app_manager_scripts/concur_install_uninstall_different_app_admin_user.py -ip 10.92.234.16 -env qa1
    ...
    test = ConcurrentInstallUninstallDifferentAppAdminUser(parser)
    resp = test.main()

# -*- coding: utf-8 -*-
""" Test cases to check 2G wifi change [KAM-23834]
"""
...
class WifiChange2GVerify(TestCase):

    TEST_SUITE = 'Functional Test'
    TEST_NAME = 'Change 2G wifi and Verify'
    # Popcorn
    TEST_JIRA_ID = 'KAM-23834'
    ...
    def init(self):
        ...
        #Set rest-api
        self.REST_API = RestAPI(self.env.uut_ip, self.env.cloud_env, self.env.username, self.env.password, root_log='wifi_change_2g_verify_')
        ...
        self.firstEnv = self.ssid_2G
        self.firstPW = self.ssid_2G_password
        self.secondEnv = self.ssid_5G
        self.secondPW = self.ssid_5G_password
...
if __name__ == '__main__':
    ...
    test = WifiChange2GVerify(parser)
    resp = test.main()

...
from integration_tests.power_failure_io_stress import PowerOnOffRWTest
from integration_tests.ffmpeg_stress import FFmpegStressTest
    ...
    def init(self):
        ...
        if self.single_run:
            ...
            self.integration.add_testcases(testcases=[
                ...
                (PowerOnOffRWTest, {'test_file_size': 524288000, 'existed_files': 5, 'loop_times': 1}),

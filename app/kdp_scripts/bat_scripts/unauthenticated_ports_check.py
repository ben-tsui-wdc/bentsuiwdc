...
class UnauthenticatedPortsCheck(KDPTestCase):

    TEST_SUITE = 'KDP_Platform_BAT'
    TEST_NAME = 'KDP-201 - Unauthenticated ports check'
    TEST_JIRA_ID = 'KDP-201'
...
if __name__ == '__main__':
    parser = KDPInputArgumentParser("""\
        *** Unauthenticalted ports check script ***
        Examples: ./run.sh kdp_scripts/bat_scripts/unauthenticated_ports_check.py --uut_ip 10.92.224.68\
        """)

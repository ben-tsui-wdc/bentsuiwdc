...
class WindowsSMBUpload(KDPTestCase):
    ...
    def after_loop(self):
        ...
        if self.html_format == '2':
            html_inst.table_title_column = ['product', 'build', 'RestSDK', 'iteration', 'TotalBytes', 'TotalRealFiles', 'NasAdmin', 'WiFiMode', 'UpAvgSpd','TargetUpAvgSpd']
        ...
        csv_inst = CsvFormat()
        csv_inst.csv_title_column = ['product', 'Direction', 'Client', "Protocol", "FileType", 'TotalRealFiles', 'TotalBytes', 'build', 'NasAdmin', 'WiFiMode', 'UpAvgSpd', 'TransferRate_unit', 'count', 'executionTime']

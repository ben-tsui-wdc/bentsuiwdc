# -*- coding: utf-8 -*-
""" Test cases to auto connect Wi-Fi AP 2.4G after device abnormal shutdown [KDP-298]
"""
...
class AutoConnect2GAfterShutdown(WifiChange5GTo2G):

    TEST_SUITE = 'Functional Test'
    TEST_NAME = 'KDP-304: Auto connect Wi-Fi AP 2.4G after device abnormal shutdown'
    # Popcorn
    TEST_JIRA_ID = 'KDP-304'

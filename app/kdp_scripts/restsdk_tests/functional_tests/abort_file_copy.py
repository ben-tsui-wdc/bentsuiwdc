...
if __name__ == '__main__':
    parser = KDPInputArgumentParser("""\
        *** Abort_File_Copy test on Kamino Android ***
        Examples: ./run.sh kdp_scripts/restsdk_tests/functional_tests/abort_file_copy.py --uut_ip 10.136.137.159\
        """)

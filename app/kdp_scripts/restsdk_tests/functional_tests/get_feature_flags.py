...
class GetFeatureFlags(KDPTestCase):
    ...
    def verify_flags(self, flags):
        ...
        for k, v in expected_flags.iteritems():
            ...
            if flags[k] != v:
                raise self.err.TestFailure('Flag value of "{}" is not correct.'.format(k))
